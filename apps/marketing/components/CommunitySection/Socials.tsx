...
export default function Socials({ className }: socialProps) {
  return (
    <div className={classJoin("flex flex-row", className || "")}>
      {socials.map((social, i) => (
        <button key={i}>
          <a href={social.link} className="relative">
            <div className="p-2 rounded-lg bg-surface flex justify-center items-center">
